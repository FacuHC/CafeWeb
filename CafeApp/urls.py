...
from .views import TrabajadoresForm, buscar_order, buscar_producto, buscar_trabajador, busqueda_order, busqueda_producto, busqueda_trabajador, ordenarForm, form_productos, inicio, lista_order, lista_producto, lista_trabajadores
